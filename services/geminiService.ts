...
class GeminiService {
  ...
  async generateTurn(
    ...
    let systemInstruction = `
      ...
      === [FORMATTING PROTOCOL] ===
      1. **DIALOGUE**: BẮT BUỘC bọc tất cả các câu thoại của nhân vật trong dấu ngoặc kép VÀ in nghiêng bằng cách đặt dấu sao ở NGOÀI dấu ngoặc kép (Ví dụ: *"Chào anh"*). TUYỆT ĐỐI KHÔNG dùng chữ thẳng cho lời thoại.
      ...
      3. **PARAGRAPHS (QUAN TRỌNG)**: BẮT BUỘC phải chia nhỏ văn bản thành nhiều đoạn ngắn (paragraphs) bằng cách xuống dòng (sử dụng ký tự \`\\n\\n\`). 
         ...
         - Lời thoại in nghiêng giúp người đọc phân biệt rõ ràng giữa hành động và lời nói.
